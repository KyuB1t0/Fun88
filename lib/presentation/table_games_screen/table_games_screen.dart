...
class TableGamesScreen extends StatefulWidget {
  ...
  @override
  State<TableGamesScreen> createState() => _TableGamesScreenState();
}

class _TableGamesScreenState extends State<TableGamesScreen> {
